...
class HomeFeatureServiceTest {
    ...
    @Test
    fun `should have loaded loadable state when refresh succeeds`() =
        runTest {
            // given
            val service = createService(shouldFail = false)
    ...
    @Test
    fun `should have error loadable state when refresh fails`() =
        runTest {
            // given
    ...
    @Test
    fun `should have generic error loadable state when refresh fails unexpectedly`() =
        runTest {
            // given
            val service =
                HomeFeatureService(
    ...
    private fun createService(shouldFail: Boolean): HomeFeatureService =
        HomeFeatureService(
            counterRepository =
