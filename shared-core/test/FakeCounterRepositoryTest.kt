...
class FakeCounterRepositoryTest {
    @Test
    fun `should return first fibonacci counter value when request succeeds from zero`() = runTest {
        // given
    ...
    @Test
    fun `should return next fibonacci counter value when request succeeds from first fibonacci value`() = runTest {
        // given
        val repository = createRepository(shouldFail = false)
    ...
    @Test
    fun `should return next fibonacci counter value when request succeeds from later fibonacci value`() = runTest {
        // given
        val repository = createRepository(shouldFail = false)
    ...
    @Test
    fun `should throw repository exception when failure policy requests failure`() = runTest {
        // given
        val repository = createRepository(shouldFail = true)

        // when
        val error = assertFailsWith<CounterRepositoryException> {
